...
module.exports = React.createClass({
		  ...
		  initialize: function() {
		  		...
		  		console.log('lat ', self.state.lat);
		  		console.log('lng ', self.state.lng);
				var styles = [
					  {
					    featureType: "all",
					    stylers: [
				...
				<div className="col-sm-12 ">
				 ...
				 <CarouselItem className="carouselItem ">
				   ...
				   <div className="imgHolder2 img1" alt='900x500'></div>
					  <div id="mapHolder2" className={this.state.mapStyle}><div style = {style}  className="map-canvas"></div></div>
